exports.create = () =>{
  ...
  let imageView = new tabris.ImageView({layoutData:{centerX: 0,width: 200,height: 100,top:20,},image:{src: "img/logo.png"},scaleMode: "fit"}).appendTo(scrollView);
  let login = new tabris.TextInput({layoutData:{top: 135,left:"10%",right:"10%",},font: "16px roboto, noto",message: "Entrez votre identifiant ou adresse mail",borderColor:themeColor}).appendTo(scrollView);
  let password = new tabris.TextInput({layoutData:{top:210,left:"10%",right:"10%",},font: "16px roboto, noto",message: "Entrez votre mot de passe",type:"password",borderColor:themeColor}).appendTo(scrollView);
  let button = new tabris.Button({layoutData:{ top:290,left:"10%",right:"10%"},font: "16px roboto, noto",textColor:"#fff",text:"Connexion",background: themeColor,elevation:0
  }).on("select", () =>{
 ...
 let inscription = new tabris.Button({layoutData:{top:365,left:"10%",right:"10%"},font: "16px roboto, noto",text:"Créer un compte",textColor:"#212121",
   background: "#eeeeee",
   elevation:0
}).on("select", () =>{  
...
let forgetPassword = new tabris.TextView({layoutData:{top:440,centerX:0},font: "16px roboto, noto",text:"Mot de passe oublié?",textColor:"#263238",
}).on("tap", () =>{
